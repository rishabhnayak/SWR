...
import ml.rishabhnayak.swr.ForceUpdate.ForceUpdateChecker;
import ml.rishabhnayak.swr.POJO.Register;
        ...
        StringRequest postRequest = new StringRequest(Request.Method.POST, url,
                ...
                new Response.ErrorListener()
                {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        ...
                        loading("no");
                        Toast.makeText(LoginActivity.this, "server problem please retry", Toast.LENGTH_SHORT).show();
                    }
                }
        ) {
            @Override
...
public void splash(){
    ...
    handler.postDelayed(new Runnable() {
        @Override
        public void run() {
           ExpandableLayout expandableLayout= findViewById(R.id.expandable_splash);
